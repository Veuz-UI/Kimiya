...
<body>
        ...
        <?php include 'header.php';?>
         ...
         <div class="inner-banner-bawn">
         </div>
             <!-------------------- Our Products section -------------------->
    <section data-aos="fade-up">
        <div class="container">
            <h2 class="heading-products">Find your next favourite from Bawn product </h2>
        ...
        <div class="container-small">
            <div class="row d-flex align-items-center gx-3">
                <div class="col-lg-6"data-aos="fade-right">
                    <img src="img/bawn1.jpg" alt="" class="img-fluid home-about-img2 space-remove">
                </div>
                <div class="col-lg-6" data-aos="fade-left">
                    <h2 class="heading"><span>Bawn</span><br>Jarardar Fernadas </h2>
